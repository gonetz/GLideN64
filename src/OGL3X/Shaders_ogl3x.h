...
#ifdef GL_MULTISAMPLING_SUPPORT
"lowp vec4 readTexMS(in lowp sampler2DMS mstex, in mediump vec2 texCoord, in lowp int fb8bit, in bool fbFixedAlpha);	\n"
...
"  if (fb8bit == 2) {							\n"
"     mediump float fc = texColor.r*255.0;		\n"
"     texColor.a = mod(fc, 16.0)/15.0;			\n"
"	  mediump int ic = int(fc);					\n"
"     texColor.rgb = vec3(float(ic&240)/255.0);	\n"
"  } else if (fb8bit == 1)						\n"
