...
PFNGLVIEWPORTINDEXEDFPROC ptrViewportIndexedf;
PFNGLVIEWPORTINDEXEDFVPROC ptrViewportIndexedfv;
...
void initGLFunctions()
{
	...
	GL_GET_PROC_ADR(PFNGLVIEWPORTINDEXEDFPROC, ViewportIndexedf);
	GL_GET_PROC_ADR(PFNGLVIEWPORTINDEXEDFVPROC, ViewportIndexedfv);
