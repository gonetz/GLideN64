...
PFNGLGETTEXLEVELPARAMETERIVPROC ptrGetTexLevelParameteriv;
...
void initGLFunctions()
{
	...
	GL_GET_PROC_ADR(PFNGLGETTEXLEVELPARAMETERIVPROC, GetTexLevelParameteriv);
#if defined(OS_ANDROID)
	...
	ASSIGN_PROC_ADR(PFNGLGETTEXLEVELPARAMETERIVPROC, GetTexLevelParameteriv);
#endif
