...
namespace
{
	template <unsigned int M, unsigned int N> inline
		uint32_t gradientBGR(uint32_t pixFront, uint32_t pixBack) //blend front color with opacity M / N over opaque background: https://en.wikipedia.org/wiki/Alpha_compositing#Alpha_blending
	{
...
#if 0
	inline
		double distBGR(uint32_t pix1, uint32_t pix2)
	{
...
#undef i
	...
	struct ColorDistanceUnbufferedABGR
	{
		static double dist(uint32_t pix1, uint32_t pix2, double luminanceWeight)
		{
			const double a1 = getAlpha(pix1) / 255.0;
...
void xbrz::scale(size_t factor, const uint32_t* src, uint32_t* trg, int srcWidth, int srcHeight, ColorFormat colFmt, const xbrz::ScalerCfg& cfg, int yFirst, int yLast)
{
	...
	case ColorFormat::BGR:
		...
		{
		case 2:
			return scaleImage<Scaler2x<ColorGradientBGR>, ColorDistanceBGR, OobReaderDuplicate>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 3:
			return scaleImage<Scaler3x<ColorGradientBGR>, ColorDistanceBGR, OobReaderDuplicate>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 4:
			return scaleImage<Scaler4x<ColorGradientBGR>, ColorDistanceBGR, OobReaderDuplicate>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 5:
			return scaleImage<Scaler5x<ColorGradientBGR>, ColorDistanceBGR, OobReaderDuplicate>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 6:
			return scaleImage<Scaler6x<ColorGradientBGR>, ColorDistanceBGR, OobReaderDuplicate>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		}
		break;
	...
	case ColorFormat::ABGR:
		...
		{
		case 2:
			return scaleImage<Scaler2x<ColorGradientABGR>, ColorDistanceABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 3:
			return scaleImage<Scaler3x<ColorGradientABGR>, ColorDistanceABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 4:
			return scaleImage<Scaler4x<ColorGradientABGR>, ColorDistanceABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 5:
			return scaleImage<Scaler5x<ColorGradientABGR>, ColorDistanceABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 6:
			return scaleImage<Scaler6x<ColorGradientABGR>, ColorDistanceABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		}
		break;

	case ColorFormat::ABGR_UNBUFFERED:
		switch (factor)
		{
		case 2:
			return scaleImage<Scaler2x<ColorGradientABGR>, ColorDistanceUnbufferedABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 3:
			return scaleImage<Scaler3x<ColorGradientABGR>, ColorDistanceUnbufferedABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 4:
			return scaleImage<Scaler4x<ColorGradientABGR>, ColorDistanceUnbufferedABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 5:
			return scaleImage<Scaler5x<ColorGradientABGR>, ColorDistanceUnbufferedABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		case 6:
			return scaleImage<Scaler6x<ColorGradientABGR>, ColorDistanceUnbufferedABGR, OobReaderTransparent>(src, trg, srcWidth, srcHeight, cfg, yFirst, yLast);
		}
		break;
	}
	assert(false);
...
bool xbrz::equalColorTest(uint32_t col1, uint32_t col2, ColorFormat colFmt, double luminanceWeight, double equalColorTolerance)
{
	...
	case ColorFormat::ABGR_UNBUFFERED:
		return ColorDistanceUnbufferedABGR::dist(col1, col2, luminanceWeight) < equalColorTolerance;
	}
	assert(false);
	return false;
}
