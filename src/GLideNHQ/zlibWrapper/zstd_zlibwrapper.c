...
ZEXTERN int ZEXPORT z_deflate _Z_OF((z_streamp strm, int flush))
{
    ...
    if (flush == Z_FULL_FLUSH
        ...
        || flush == Z_BLOCK)
    {
        char msg[] = "Z_FULL_FLUSH, Z_BLOCK and Z_TREES are not supported!";
        return ZWRAPC_finishWithErrorMsg(strm, msg);
    }
                                    ...
                                    z_streamp source))
{
    ...
    char msg[] = "deflateCopy is not supported!";
    return ZWRAPC_finishWithErrorMsg(source, msg);
}
                                    ...
                                    int max_chain))
{
    ...
    char msg[] = "deflateTune is not supported!";
    return ZWRAPC_finishWithErrorMsg(strm, msg);
}
                                       ...
                                       int *bits))
{
    ...
    char msg[] = "deflatePending is not supported!";
    return ZWRAPC_finishWithErrorMsg(strm, msg);
}
#endif
                                     ...
                                     int value))
{
    ...
    char msg[] = "deflatePrime is not supported!";
    return ZWRAPC_finishWithErrorMsg(strm, msg);
}
                                         ...
                                         gz_headerp head))
{
    ...
    char msg[] = "deflateSetHeader is not supported!";
    return ZWRAPC_finishWithErrorMsg(strm, msg);
}
                                             ...
                                             uInt  *dictLength))
{
    ...
    char msg[] = "inflateGetDictionary is not supported!";
    return ZWRAPD_finishWithErrorMsg(strm, msg);
}
#endif
                                    ...
                                    z_streamp source))
{
    ...
    char msg[] = "inflateCopy is not supported!";
    return ZWRAPD_finishWithErrorMsg(source, msg);
}
...
ZEXTERN long ZEXPORT z_inflateMark _Z_OF((z_streamp strm))
{
    ...
    char msg[] = "inflateMark is not supported!";
    return ZWRAPD_finishWithErrorMsg(strm, msg);
}
#endif
                                     ...
                                     int value))
{
    ...
    char msg[] = "inflatePrime is not supported!";
    return ZWRAPD_finishWithErrorMsg(strm, msg);
}
                                         ...
                                         gz_headerp head))
{
    ...
    char msg[] = "inflateGetHeader is not supported!";
    return ZWRAPD_finishWithErrorMsg(strm, msg);
}
                                         ...
                                         int stream_size))
{
    ...
    char msg[] = "inflateBackInit is not supported!";
    return ZWRAPD_finishWithErrorMsg(strm, msg);
}
                                    ...
                                    out_func out, void FAR *out_desc))
{
    ...
    char msg[] = "inflateBack is not supported!";
    return ZWRAPD_finishWithErrorMsg(strm, msg);
}
...
ZEXTERN int ZEXPORT z_inflateBackEnd _Z_OF((z_streamp strm))
{
    ...
    char msg[] = "inflateBackEnd is not supported!";
    return ZWRAPD_finishWithErrorMsg(strm, msg);
}
