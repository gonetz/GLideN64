...
void ShaderCombiner::updateFogMode(bool _bForce)
{
	...
	const int nFogBlendEnabled = config.generalEmulation.enableFog != 0 && (gDP.otherMode.c1_m1a == 3 || gDP.otherMode.c1_m2a == 3 || gDP.otherMode.c2_m1a == 3 || gDP.otherMode.c2_m2a == 3) ? 256 : 0;
